...
namespace StaffManagementApp.Tests.TestCases
{
    public class ExceptionalTests
    {
        ...
        [Fact]
        public async Task<bool> Testfor_Get_Stafft_ById_NotNull()
        {
            //Arrange
            var res = false;
        ...
        [Fact]
        public async Task<bool> Testfor_Update_Staff_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
            ...
            try
            {
                 staffservice.Setup(repos => repos.UpdateStaff(_Staff)).Returns(_Staff);
                var result =  _staffService.UpdateStaff(_Staff);
                //Assertion
                if (result != null)
                {
                    res = true;
